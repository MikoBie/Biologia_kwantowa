...
example_result %>%
  ...
  rename("Przewidywany element"=item,
         ...
         Historia=history) %>%
  kable("html", caption="Tabela 1. Przykładowe wyniki algorytmu") %>% kable_styling("responsive", full_width = FALSE)

sum(example_result$item[2:14] ==example_result$ciag[2:14])/13
